 ...
 <div class="news-section">
	<?php $form = ActiveForm::begin([
	 ...
	 <h1>Newsletter<br>
		...
		<div id="success" style="display:none;color: #088708;font-size: 25px;"></div></br>
		<!--a href="#">See the December Issue ></a--> 

	<?php ActiveForm::end(); ?>	
	<h3><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i>Free Shipping & Free Returns</a> </h3>	
</div>
