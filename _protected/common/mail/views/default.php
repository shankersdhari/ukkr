    ...
    <tr>
      <td style="text-align:center; padding:5px;font-size:15px; vertical-align:top; margin:0; background:#F5F5F5;
        padding: 30px 0 20px;">
      <div style="padding:0;float: left; margin:0 auto;  width:auto; font-size:16px; color:#666;  text-align: center;  display: inline-block;">
      
     <p style="margin:0;  text-align:left; padding:0; margin-bottom:15px;"><?= $body['message'] ?> </p>
